...
const Proposals = ({ votedProposals, proposalBalances, provider, dao, proposals, quorum, setIsLoading }) => {
      ...
      <tbody>
        {proposals.map((proposal, index) => (
          <tr key={index}>
            ...
            <td>{ethers.utils.formatUnits(proposalBalances.get(proposal.recipient), "ether")} ETH</td>
